...
class Instance():
    ...
    def __init__(self, sim_setting):
        ...
        self.c_sij = np.random.rand(self.n_scenarios, self.n_crops, self.n_harvesting_dates)*100
        
        #Demand {costumer, harvesting_date}
        self.d_mj = np.random.rand(self.n_customers, self.n_harvesting_dates)*10
        
        #Profit {costumer, harvesting_date}
        self.f_mj = np.random.rand(self.n_customers, self.n_harvesting_dates)*50
        
        #Surplus selling to the market {scenario, harvesting_date}
        self.s_sj = np.random.rand(self.n_scenarios, self.n_harvesting_dates)*25
        ...
        self.p_smj = np.random.rand(self.n_scenarios, self.n_customers, self.n_harvesting_dates)*3
